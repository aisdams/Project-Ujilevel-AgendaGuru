...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="index.html">{{--{{ Auth::user()->level }}--}}</a>
                        ...
                        <li class="nav-item dropdown nav-user">
                            <a class="nav-link nav-user-img" href="#" id="navbarDropdownMenuLink2"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    src="{{asset('sm.png')}}" alt="" class="user-avatar-md rounded-circle"></a>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse mt-4" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            <li class="nav-divider fs-5 mb-3">
                                Menu
                            </li>
                             @if (auth()->user()->level == "admin")
                            <li class="nav-item ">
                                <a class="nav-link" href="{{ url('/') }}" data-toggle="collapse" aria-expanded="false"
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="{{ url('/editor') }}" data-toggle="collapse" aria-expanded="false"
                                    data-target="#submenu-1" aria-controls="submenu-1"><i
                                        class="fa fa-fw fa-user-circle"></i>Dashboard Guru<span
                                        class="badge badge-success">6</span></a>
                            </li>
                            @endif
                             ...
                             @if (auth()->user()->level == "admin")
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('guru') }}" data-toggle="collapse" aria-expanded="false"
                                    data-target="#submenu-2" aria-controls="submenu-2"><i
                                        class="fa fa-fw fa-rocket"></i>Data Guru</a>
                            </li>
                            @endif
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('/kelas') }}" data-toggle="collapse" aria-expanded="false"
                                    data-target="#submenu-3" aria-controls="submenu-3"><i
                                        class="fas fa-fw fa-chart-pie"></i>Data Kelas</a>
                            </li>
                             @endif       
                            
                            <li class="nav-item mb-5">
                                <a class="nav-link" href="{{ url('agenda') }}" data-toggle="collapse" aria-expanded="false"
                                    data-target="#submenu-4" aria-controls="submenu-4"><i
                                        class="fab fa-fw fa-wpforms"></i>Forms Agenda</a>
                            </li>
                            <li class="nav-item mt-5">
                                <a class="nav-link" href="{{ url('logout') }}" data-toggle="collapse" aria-expanded="false"
                                    data-target="#submenu-5" aria-controls="submenu-4"><i class="fa-solid fa-right-from-bracket"></i>Logout</a>
                            </li>
                                    </ul>
                                </div>
                            </li>
        ...
        <div class="dashboard-wrapper">
            ...
            <!-- ============================================================== -->
            <!-- end footer -->
        <div class="fotternya" style="margin-top: 10rem">
            <p class="text-center">Copyright © 2018 <a href="https://colorlib.com/wp/free-admin-templates/">Colorlib</a> . All rights reserved. Template by Colorlib.</p>
        </div>
            <!-- ============================================================== -->
        </div>
        <!-- ============================================================== -->
    ...
    <!-- jquery 3.3.1 -->
    // <script src="{{ asset('template/assets/vendor/jquery/jquery-3.3.1.min.js') }}">
